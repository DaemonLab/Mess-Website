...
class Caterer(models.Model):
    ...
    lower_description = models.TextField(_("Lower Discription"),default="", help_text="This contains the description of the respective caterer that will show on the lower side.")
    student_limit = models.IntegerField(_("Caterers Student Limit"),default=0, help_text="The limit on number of students it can have")
