...
class AllocationResource(resources.ModelResource):
    ...
    caterer__name = fields.Field(
        attribute="caterer__name", column_name="Caterer Allocated"
    )
...
class RebateBillsResource(resources.ModelResource):
    ...
    period4_high_tea = fields.Field(
        attribute="period4_high_tea", column_name="High Tea 4"
    )
    period4_bill = fields.Field(attribute="period4_bill", column_name="Bill 4")
    allocation5 = fields.Field(
        attribute="allocation5", column_name="Allocation for period 5"
    )
    period5_short = fields.Field(
        attribute="period5_short", column_name="Short Rebate 5"
    )
    period5_long = fields.Field(attribute="period5_long", column_name="Long Rebate 5")
    period5_high_tea = fields.Field(
    ...
    period6_high_tea = fields.Field(
        attribute="period6_high_tea", column_name="High Tea 6"
    )
    period6_bill = fields.Field(attribute="period6_bill", column_name="Bill 6")
    empty = fields.Field(attribute="empty", column_name="")
    last_sem_fee = fields.Field(
        attribute="last_sem_fee", column_name="Last Semester Fee"
    )
    total = fields.Field(attribute="total", column_name="Total")
    upcoming_sem_fee = fields.Field(
        attribute="upcoming_sem_fee", column_name="Upcoming Semester Fee"
    )
    upcoming_sem_due = fields.Field(
        attribute="upcoming_sem_due", column_name="Upcoming Semester Dues"
    )
    ...
    def before_import_row(self, row, **kwargs):
        ...
        for field_name, field_object in self.fields.items():
            if (
                field_object.column_name
                and field_object.column_name.lower() == "true"
                or field_object.column_name == 1
            ):
                row[field_name] = True
...
class CatererBillsResource(resources.ModelResource):
    ...
    period1_bills = fields.Field(
        attribute="period1_bills", column_name="Period 1 Bills"
    )
    period2_bills = fields.Field(
        attribute="period2_bills", column_name="Period 2 Bills"
    )
    period3_bills = fields.Field(
        attribute="period3_bills", column_name="Period 3 Bills"
    )
    period4_bills = fields.Field(
        attribute="period4_bills", column_name="Period 4 Bills"
    )
    period5_bills = fields.Field(
        attribute="period5_bills", column_name="Period 5 Bills"
    )
    period6_bills = fields.Field(
        attribute="period6_bills", column_name="Period 6 Bills"
    )
