...
class Semester(models.Model):
    name = models.CharField(
        ...
        null=True,
        blank=True,
        help_text="Name of the semester",
    )
...
class Allocation(models.Model):
    ...
    email = models.ForeignKey(Student, default=0, on_delete=models.SET_NULL, null=True)
    ...
    jain = models.BooleanField(
        _("Jain"),
        help_text="This contains the info if jain food is taken or not",
        default=False,
        null=True,
        blank=True,
    )
