    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        verbose_name="Caterers Student Limit",
                    ),
                ),
                (
                    "visible",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "prev_sem_fee",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Previous Semester Fee"
                    ),
                ),
                (
                    "upcoming_sem_fee",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Upcoming Semester Fee"
                    ),
                ),
                (
                    "program",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.CharField(default="", max_length=30, verbose_name="email"),
                ),
                (
                    "start_date",
                    models.DateField(
                        blank=True, help_text="start date of the rebate", null=True
                    ),
                ),
                (
                    "end_date",
                    models.DateField(
                        blank=True, help_text="end date of the rebate", null=True
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        ...
                        help_text="Date on which the rebate was applied",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="This contains the serial number of the Period",
                        verbose_name="Sno",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "show_allocated",
                    models.BooleanField(default=False, verbose_name="show_allocated"),
                ),
                (
                    "period",
                    models.ForeignKey(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=10,
                        null=True,
                        verbose_name="Second Preference",
                    ),
                ),
                (
                    "third_pref",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period1_bills",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 1 Bill"
                    ),
                ),
                (
                    "period2_bills",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 2 Bill"
                    ),
                ),
                (
                    "period3_bills",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 3 Bill"
                    ),
                ),
                (
                    "period4_bills",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 4 Bill"
                    ),
                ),
                (
                    "period5_bills",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 5 Bill"
                    ),
                ),
                (
                    "period6_bills",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 6 Bill"
                    ),
                ),
                (
                    "caterer",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period1_short",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 1 Short"
                    ),
                ),
                (
                    "period1_long",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 1 Long"
                    ),
                ),
                (
                    "period1_high_tea",
                    models.BooleanField(
                        default=True, null=True, verbose_name="Period 1 High Tea"
                    ),
                ),
                (
                    "period1_bill",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 1 Rebate Amount"
                    ),
                ),
                (
                    "period2_short",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 2 Short"
                    ),
                ),
                (
                    "period2_long",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 2 Long"
                    ),
                ),
                (
                    "period2_high_tea",
                    models.BooleanField(
                        default=True, null=True, verbose_name="Period 2 High Tea"
                    ),
                ),
                (
                    "period2_bill",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 2 Rebate Amount"
                    ),
                ),
                (
                    "period3_short",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 3 Short"
                    ),
                ),
                (
                    "period3_long",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 3 Long"
                    ),
                ),
                (
                    "period3_high_tea",
                    models.BooleanField(
                        default=True, null=True, verbose_name="Period 3 High Tea"
                    ),
                ),
                (
                    "period3_bill",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 3 Rebate Amount"
                    ),
                ),
                (
                    "period4_short",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 4 Short"
                    ),
                ),
                (
                    "period4_long",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 4 Long"
                    ),
                ),
                (
                    "period4_high_tea",
                    models.BooleanField(
                        default=True, null=True, verbose_name="Period 4 High Tea"
                    ),
                ),
                (
                    "period4_bill",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 4 Rebate Amount"
                    ),
                ),
                (
                    "period5_short",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 5 Short"
                    ),
                ),
                (
                    "period5_long",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 5 Long"
                    ),
                ),
                (
                    "period5_high_tea",
                    models.BooleanField(
                        default=True, null=True, verbose_name="Period 5 High Tea"
                    ),
                ),
                (
                    "period5_bill",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 5 Rebate Amount"
                    ),
                ),
                (
                    "period6_short",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 6 Short"
                    ),
                ),
                (
                    "period6_long",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 6 Long"
                    ),
                ),
                (
                    "period6_high_tea",
                    models.BooleanField(
                        default=True, null=True, verbose_name="Period 6 High Tea"
                    ),
                ),
                (
                    "period6_bill",
                    models.IntegerField(
                        default=0, null=True, verbose_name="Period 6 Rebate Amount"
                    ),
                ),
                (
                    "email",
